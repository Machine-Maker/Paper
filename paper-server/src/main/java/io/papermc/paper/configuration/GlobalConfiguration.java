...
public class GlobalConfiguration extends ConfigurationPart {
    ...
    static final int CURRENT_VERSION = 31; // (when you change the version, change the comment, so it conflicts on rebases): merge spigot.yml and bukkit.yml
    ...
    public class Stats extends ConfigurationPart {
        public boolean disableSaving = false;
        public Object2IntMap<Holder<ResourceLocation>> forcedCustomStatValues;
    }
